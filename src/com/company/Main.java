...
/*    Rat mitRat = new Rat(0,40,false,true);
    Motor minMotor = new Motor(100,2,false);
    Hjul mitHjul = new Hjul(16, "Hurricane","Helårsdæk");
...
/*        int valg;
        ...
        while (minBil.motorStatus) {
            ...
            if (svar == 1) {
                ...
                System.out.println("Din hastighed er forøget med 1´% og er nu: " + minBil.hastighed);
                continue;
            } else if (svar == 2) {
                minBil.formindskHastighed();
                System.out.println("Din hastighed er formindsket med 1´% og er nu: " + minBil.hastighed);
                continue;
            } else if (svar == 3) {
                minBil.SlukMotor();
